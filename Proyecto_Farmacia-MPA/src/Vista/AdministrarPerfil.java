...
public class AdministrarPerfil extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/add.jpg"))); // NOI18N
        jpAdmin.add(txtImagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 193, 202));

        getContentPane().add(jpAdmin);
        jpAdmin.setBounds(440, 70, 200, 220);
